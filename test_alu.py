...
def fixed_point_to_float(value):
    # mask and shift
    integer_part = (value >> 4) & 0xF  # top 4 bits
    fractional_part = value & 0xF       # bottom 4 bits

    # fractional part scaled by 1/16 because 4 bits fraction means 16 subdivisions
    fraction = fractional_part / 16.0
